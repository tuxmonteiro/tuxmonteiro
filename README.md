...
- **Software Engineer** : Java (with Functional Programming approach, ProjectReactor and Spring framework), Python and Shell scripting expertise (but with experience with Ruby, Clojure, Kotlin, Go, and C++). I love BDD and profilers.
